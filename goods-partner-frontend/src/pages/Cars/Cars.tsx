...
const Cars = () => {
    ...
    return <section>
        ...
        {isAddCarDialogOpen && <CarFormDialog closeDialog={() => setIsAddCarDialogOpen(false)} open={isAddCarDialogOpen}
                                              car={newCar}
                                              title={"Додати авто"}
                                              setCar={setNewCar}
...
function BasicMenu({car, deleteCar, setEditedCar, openEditDialog}: BasicMenuProps) {
