...
export default function UserFormDialog({title, closeDialog, open, actionHandler, user, setUser}) {
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            <TextField id="outlined-basic"
                                       ...
                                       required label="Пошта" variant="outlined"/>
                        </Grid>
                        ...
                        <Grid item xs={12} sx={{mt: 2}}>
                            <FormGroup>
                                <FormControlLabel control={<Checkbox/>} checked={user.enabled}
                                                  onChange={handleEnabled} label="Активний"/>
                            </FormGroup>
                        </Grid>
