-- Cleanup
-- delete from grandedolce_orders;
-- delete from car_loads;
-- delete from route_points;
-- delete from routes;
-- delete from deliveries_history;
...
insert into public.cars (id, name, licence_plate, driver, weight_capacity, cooler, available, travel_cost)
values  (1, 'Mercedes Sprinter', 'AA 3333 CT', 'Anton Geraschenko', 2500, true, true, 15),
        (51, 'Mercedes 818', 'AA 4444 CT', 'Serhiy Kotovich', 4000, false, true, 20),
        (101, 'Mercedes Sprinter', 'AA 1111 CT', 'Oleg Dudka', 2000, false, true, 12),
        (151, 'Mercedes Vito', 'AA 2222 CT', 'Ivan Piddubny', 1000, false, true, 10);
...
insert into public.grandedolce_orders (id, order_number, shipping_date, client_name, address, manager, excluded, dropped, delivery_type, order_weight, ref_key, comment, delivery_id, reschedule_date, car_load_id, route_point_id, is_frozen, delivery_start, delivery_finish, products)
values
    (1, '123', '2022-09-14', 'ТОВ "Кондитерська', 'м. Київ, вул. Хрещатик, 1', 'Ірина Шефір', false, false, 'REGULAR', 750.00, 'ref1', 'Терміново', 'd667c8f0-b961-49c6-b6bc-3f9a98b6c5da', null, '8587e3ce-e7ee-4ba3-92b1-8396c423e372', 1, true, '09:00:00', '17:00:00',
    ...
    (51, '254', '2022-09-15', 'ТОВ "Хлібзавод', 'м. Київ, вул. Глибочицька, 12Б, оф. 3', 'Антон Василенко', false, false, 'POSTAL', 532.00, 'ref2', '', '4f0a02c1-083c-4d62-b678-2c5eea17f6d1', null, 'a7bdd2c5-1d65-4dad-8ae5-57213c96f7ba', 51, false, '09:30:00', '16:30:00',
    ...
    (101, '432', '2022-09-14', 'ТОВ "Хлібзавод', 'м. Київ, вул. Глибочицька, 12Б, оф. 3', 'Ірина Шефір', false, true, 'REGULAR', 1420.00, 'ref3', '', 'd667c8f0-b961-49c6-b6bc-3f9a98b6c5da', null, '8587e3ce-e7ee-4ba3-92b1-8396c423e372', 101, false, '09:00:00', '14:00:00',
    ...
    (151, '254', '2022-09-15', 'ТОВ "Пекарня', 'м. Київ, вул. Металістів, 8, оф. 4-24', 'Андрій Бугаенєко', true, false, 'REGULAR', 382.00, 'ref4', 'Забрати документи', '4f0a02c1-083c-4d62-b678-2c5eea17f6d1', null, 'a7bdd2c5-1d65-4dad-8ae5-57213c96f7ba', 151, false,'10:00:00', '15:00:00',
    '[{"amount": 10, "storeName": "Склад №1", "unitWeight": 15.0, "productName": "Глазур кондитерська біла (диски) (15 кг)", "totalProductWeight": 150.0}, {"amount": 10, "storeName": "Склад №1", "unitWeight": 15.0, "productName": "Глазур кондитерська чорна (диски) (15 кг)", "totalProductWeight": 150.0}, {"amount": 4, "storeName": "Склад №1", "unitWeight": 13.0, "productName": "Каравела горіхова паста (AX52CG) 13 кг", "totalProductWeight": 52.0}, {"amount": 3, "storeName": "Склад №1", "unitWeight": 10.0, "productName": "Наповнювач персик джем (г/я 10кг)", "totalProductWeight": 30.0}]');
